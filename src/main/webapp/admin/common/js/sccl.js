...
//获取菜单icon随机色
    ...
    /*$.get("/DzBank/caid/getQuanxAll",null,function(data){
        var menu = data;
        initMenu(menu,$(".side-menu"));
        $(".side-menu > li").addClass("menu-item");
        /!*获取菜单icon随机色*!/
