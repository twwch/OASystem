...
$.fn.pagination.defaults={total:1,pageSize:15,pageNumber:1,pageList:[15,25,35,50],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_c4,_c5){
},onBeforeRefresh:function(_c6,_c7){
},onRefresh:function(_c8,_c9){
},onChangePageSize:function(_ca){
},beforePageText:"当前第 ",afterPageText:" 页 ，一共 {pages} 页",displayMsg:"当前显示 {from} 到 {to} 条， 共 {total} 条",nav:{first:{iconCls:"pagination-first",handler:function(){
